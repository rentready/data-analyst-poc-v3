...
def get_file_search_client(use_admin_key: bool = False) -> SearchClient:
    """Alias for get_search_client for backward compatibility."""
    return get_search_client(use_admin_key)
